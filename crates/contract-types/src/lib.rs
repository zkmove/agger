...
pub const AGGER_QUERY_FUNC_NAME_GET_MODULE: &str = "get_module";
pub const AGGER_QUERY_FUNC_NAME_GET_VK: &str = "get_vk";
pub const AGGER_QUERY_FUNC_NAME_GET_PARAM: &str = "get_param";
pub const AGGER_QUERY_FUNC_NAME_GET_CONFIG: &str = "get_config";
